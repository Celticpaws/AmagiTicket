...
def ticket_printed(request,pk):
    ...
    try:
        ...
        ticketpk = None
        return render(request,'TicketsApp/page_404.html',{})
    ...
    p.drawRightString(600,15,datetime.now().strftime("%d de %b del %Y a las %I:%M:%S %p"))
    ...
    p.rect(50,50-22,600,34, fill=1,stroke=False)
    p.setFillColor(black)
